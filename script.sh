...
# # hdfs-site.xml
xmleditor.py -a -p /opt/hadoop/etc/hadoop/hdfs-site.xml -n dfs.replication -v 3
xmleditor.py -a -p /opt/hadoop/etc/hadoop/hdfs-site.xml -n dfs.namenode.name.dir -v file:///opt/hadoop/data/namenode
xmleditor.py -a -p /opt/hadoop/etc/hadoop/hdfs-site.xml -n dfs.datanode.data.dir -v file:///opt/hadoop/data/datanode
